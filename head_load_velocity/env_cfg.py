...
from .curriculum import PayloadMassUpper, sample_payload_mass, update_payload_curriculum
...
def head_load_velocity_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  ...
  cfg.events = {
    "payload_curriculum": EventTermCfg(
      func=update_payload_curriculum,
      mode="step",
      params={"window_steps": 100 * unitree_g1_ppo_runner_cfg().num_steps_per_env},
    ),
